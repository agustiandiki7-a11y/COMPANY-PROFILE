<?php
// Menggunakan __DIR__ agar jalur file koneksi terbaca akurat berdasarkan direktori saat ini
include "../backend/connection.php";
// Jika file koneksi Anda ada di folder lain, sesuaikan path di atas (misal: "backend/connection.php")
    ...
    <main class="container" style="padding: 80px 0; text-align: center;">
        <div class="row justify-content-center">
            <div class="col-md-6" style="background: #171717; padding: 40px; border-radius: 12px; border: 1px solid #2b2b2b;">
                ...
                <h1 style="color: #fff;">Sampai Jumpa di GHD!</h1>
